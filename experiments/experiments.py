...
for dataset_name in datasets:
    ...
    outfile_rgttm = os.path.join(results_dir,
                                 "performance_results_%s_%s_%s_gap%s_rgttm.csv" % (
    ...
    with open(outfile_rgttm, 'w') as fout2:
        ...
        comparison_path = os.path.join(results_dir, "comparison_after_rgttm_%s_%s_%s_gap%s.csv" % (cls_method, dataset_name, method_name, gap))
